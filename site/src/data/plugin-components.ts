...
export const OFFICIAL_PLUGINS: PluginDocEntry[] = [
  ...
  },
  {
    ...
    title: "image-loader",
    blurb:
      "Ingests&nbsp;<a href=\"https://www.aseprite.org/\" target=\"_blank\" rel=\"noopener noreferrer\">Aseprite</a>&nbsp;(.aseprite / .ase) files into layered, animated entities with shared atlases and animation maps \u2014 or plain images declared per sprite texture channel, including a material channel-packed from { metallic, roughness, mask }.",
    npmPackage: "omosuen-image-loader",
    version: "0.3.0",
    releaseTag: "image-loader1.0.0",
    umdFile: "image-loader.plugin.js",
    definitionExport: "imageLoaderDefinition",
