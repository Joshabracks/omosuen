...
export declare function makeColliderOBB(): ColliderOBB;
export declare function computeWorldOBBInto(collider: ColliderT, out: ColliderOBB): void;
export declare function computeWorldSphereInto(collider: ColliderT, outCenter: Vector3D): number;
