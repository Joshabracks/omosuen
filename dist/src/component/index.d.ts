...
export type { InputControllerT as input_controller, InputControllerMethods, } from './input-controller';
...
export type { AnimationMapT as animation_map, AnimationMapMethods, } from './animation-map';
