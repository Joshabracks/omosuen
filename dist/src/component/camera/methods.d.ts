...
export interface CameraMethods extends ComponentMethods {
    ...
    setPostEffects: (camera: CameraT, effects: PostEffectOptions[] | null) => void;
    setPostEffectEnabled: (camera: CameraT, name: string, enabled: boolean) => void;
    setPostEffectUniform: (camera: CameraT, name: string, key: string, value: PostEffectUniformValue) => void;
