...
export type METHOD_TYPE = 'ui-binding' | 'html-constructor' | 'message-listener' | 'cell-map-generator' | 'post-effect';
...
export declare function disposeComponent(component: ComponentData): void;
