...
import { Material, Mesh, ChunkMesh, CellEmissionColorDirtyRegion, ChunkExploredDirtyRegion } from './types';
...
export declare function drainAuxWindowChangeMs(): number;
export declare function drainAuxFieldSyncMs(): number;
...
export declare let cmEmissionColorMap: NumericArray3D;
...
export declare let cmExploredMap: NumericArray3D;
