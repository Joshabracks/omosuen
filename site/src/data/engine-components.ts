...
export const ENGINE_COMPONENTS: ComponentDocEntry[] = [
  ...
  },
  {
    ...
    category: 'Rendering',
    blurb:
      'Axonometric view with orbit yaw, zoom, and render passes for cell-maps and sprites.',
  },
  {
    id: 'cell-map',
    title: 'cell-map',
  ...
  },
  {
    ...
    category: 'Rendering',
    blurb:
      'Textured billboard quad with atlas frames, tint, and material-driven specular/emission.',
  },
  {
    id: 'texture-map',
    title: 'texture-map',
  ...
  },
  {
    ...
    category: 'Rendering',
    blurb:
      'Fog-of-war reveal source: soft radial + real line-of-sight raycasting.',
  },
  {
    id: 'fog-of-war',
    title: 'fog-of-war',
    category: 'Rendering',
    blurb:
      'Scene-wide memory/never-viewed styling, and the per-frame driver for tracked-sprite phantom stand-ins.',
  },
  {
