...
export interface CellMapMethods extends ComponentMethods {
    ...
    setChunkExplored: (component: CellMapT, worldCx: number, worldCy: number, worldCz: number) => void;
    isChunkExplored: (component: CellMapT, worldCx: number, worldCy: number, worldCz: number) => boolean;
    setChunkFarMaterial: (component: CellMapT, worldCx: number, worldCy: number, worldCz: number, materialIndex: number) => void;
    getChunkFarMaterial: (component: CellMapT, worldCx: number, worldCy: number, worldCz: number) => number;
    setCellMemoryMaterial: (component: CellMapT, worldCellX: number, worldCellY: number, worldCellZ: number, materialIndex: number) => void;
    getCellMemoryMaterial: (component: CellMapT, worldCellX: number, worldCellY: number, worldCellZ: number) => number;
    ...
    refreshChunks: (component: CellMapT, min: {
        x: number;
        y: number;
        z: number;
    } | null, max?: {
    ...
    setCells: (component: CellMapT, entries: {
        x: number;
        y: number;
        z: number;
        data: CellData;
