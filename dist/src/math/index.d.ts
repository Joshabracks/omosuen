...
export declare class Array3Du32 implements NumericArray3D {
    size: Vector3D;
    value: Uint32Array;
    get width(): number;
    get depth(): number;
    ...
    static allocate(size: Vector3D, defaultValue?: number): Array3Du32;
    set: (coordinates: Vector3D, v: number) => void;
    indexSet: (i: number, v: number) => void;
    get: (coordinates: Vector3D) => number;
...
export declare class Array3Di {
    ...
    get depth(): number;
    get height(): number;
    constructor(data: NumericArray3D, bitWidth?: 8 | 16 | 32, bitPackingConfig?: Array<1 | 2 | 4 | 8 | 16>, overflow?: 'mod' | 'clamp' | 'fail');
...
export declare class Array3Dic {
    ...
    constructor(data: NumericArray3D, bitWidth?: 8 | 16 | 32, bitPackingConfig?: Array<1 | 2 | 4 | 8 | 16>, overflow?: 'mod' | 'clamp' | 'fail', maxMemoryThreshold?: number);
