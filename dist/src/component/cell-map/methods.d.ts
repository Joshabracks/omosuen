...
export interface CellMapMethods extends ComponentMethods {
    ...
    setCellExplored: (component: CellMapT, worldX: number, worldY: number, worldZ: number) => void;
    isCellExplored: (component: CellMapT, worldX: number, worldY: number, worldZ: number) => boolean;
