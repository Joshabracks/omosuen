export { start, stop, pause, resume, isRunning, isPaused, getFrameTime, getFPS, getFrameCount, getTargetFPS, } from './manager';
...
export { setProfilingEnabled, isProfilingEnabled, getLastFrameProfile, getFrameHistory, startSpikeCapture, isSpikeCaptureActive, } from './profile';
export type { LoopPhase, ComponentTypeTiming, ComponentInstanceTiming, FrameProfile, SpikeCaptureResult, } from './profile';
