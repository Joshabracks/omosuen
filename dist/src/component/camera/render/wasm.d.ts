...
export declare function cellStoreGeneration(): number;
export declare function setCellStoreWrap(wx: number, wy: number, wz: number): void;
export declare function rememberCell(x: number, y: number, z: number, packed: number): void;
export declare function forgetRememberedCell(x: number, y: number, z: number): void;
export declare function forgetAllRememberedCells(): void;
export declare function rememberedCellCount(): number;
export declare function hasRememberedCell(x: number, y: number, z: number): boolean;
export declare function reserveCellStoreInput(count: number): Uint32Array;
export declare function writeCellStoreBox(x0: number, y0: number, z0: number, dx: number, dy: number, dz: number): void;
